...
const DEFAULT_PHYGITAL_ITEMS: FocusRailItem[] = [
  { id: 'genesis-pass', title: 'GENESIS PASS #001', description: 'Unlock exclusive access to future physical drops and ecosystem rewards.', meta: '0.85 ETH', imageSrc: 'https://images.unsplash.com/photo-1620321023374-d1a68fbc720d?w=600&q=80', href: '/explore' },
